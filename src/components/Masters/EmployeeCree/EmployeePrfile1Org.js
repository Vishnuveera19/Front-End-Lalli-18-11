...
const Employeeprofile0909 = () => {
  ...
  <FormControl fullWidth>
    ...
    >
      <option value="">Select</option>
      {division
        .filter((d) => d.branchId === pnBranchId) // Filtering by branch ID
        .map((d) => (
          <option key={d.pnDivisionId} value={d.pnDivisionId}>
            {d.vDivisionName}
          </option>
        ))}
    </select>
                  ...
                  <Grid item xs={12} sm={4}>
                    <FormControl fullWidth>
                      ...
                      >
                        <option value="">Select</option>
                        {designation
                          .filter((e) => e.branchId === pnBranchId)
                          .map((e) => (
